...
/** Orden de presentación en el panel (sigue el flujo pedagógico del wizard) */
export const VIDEO_LIST = [
  "pasoAPaso1", "pasoAPaso2", "motivacion",  "encuadre",
  "tecnicas",   "desarrollo", "conducir",    "evaluacion",
  "listaVerif", "material",   "manualPart",  "manualInst",
];
